package objects.frame.webPages;
...
public class CommonWebNavBar {
     ...
     */
    public CommonWebNavBar(WebDriver driver) {
     ...
     */
    public CommonWebNavBar(WebDriver driver, By barHandle, By itemHandle) {
        this.myDriver = driver;
