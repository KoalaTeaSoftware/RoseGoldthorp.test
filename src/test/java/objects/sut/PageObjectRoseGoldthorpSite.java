 ...
 */
public class PageObjectRoseGoldthorpSite extends CommonWebPage {
     ...
     */
    public PageObjectRoseGoldthorpSite(WebDriver driver) {
        super(driver);
        myDriver = driver;
        new WebDriverWait(Context.defaultBrowser.getDriver(), Duration.ofSeconds(Context.pageLoadWait))
