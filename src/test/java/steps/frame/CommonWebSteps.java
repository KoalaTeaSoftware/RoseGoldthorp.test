...
import objects.frame.webPages.CommonWebPage;
 ...
 * 1) the type of the 'myPageObject' with you own extension of the CommonWebPage class
 * 2) the 'getMyPage()' with your own (because it will be creating an object of your own class)
 */
public class CommonWebSteps {

    public CommonWebPage myPageObject;
     ...
     */
    private CommonWebPage getMyPage() {
     ...
     */
    private CommonWebPage getNewPage() {
        return new CommonWebPage(Context.defaultBrowser.getDriver());
    }

    @Given("the browser is showing the page {string}")
    public void theBrowserIsShowingThePage(String resourceLocator) {
