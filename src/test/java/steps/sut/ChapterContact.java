...
import objects.sut.PageObjectContact;
import org.junit.Assert;

import java.util.Map;

public class ChapterContact {
    private PageObjectContact contactPage;

    PageObjectContact getMyPage() {
        if (contactPage == null) {
            contactPage = new PageObjectContact(Context.defaultBrowser.getDriver());
        }
        return contactPage;
    }
    ...
    public void theMessageIsNotSent() {
         ...
         *
         * If this give a false -ve, then maybe the HTML has some spaces in one of the fields that you thought was empty
         */
