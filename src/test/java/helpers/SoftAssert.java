...
public class SoftAssert {
    ...
    public void assertEquals(String expectedTitle, String readPageTitle, String unexpected_page_title) {
        if (!readPageTitle.equals(expectedTitle)) {
            this.iHaveSeenAFailure = true;
            Reports.writeToHtmlReport(unexpected_page_title);
        }
    }
}
