...
public class W3cCssChecker {
    ...
    public W3cCssChecker(String urlOfCssFile, Duration tout) {
        ...
        Context.defaultBrowser.getResource(fullUrl);

        new WebDriverWait(Context.defaultBrowser.getDriver(), tout)
    ...
    public Boolean fileValidates() {
        String resultString = Context.defaultBrowser.getDriver().findElement(By.tagName("H3")).getText();
